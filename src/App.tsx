...
const App: React.FC = () => {
  ...
  const IssueTypeItem: React.FC<{
    ...
    toggleExpand: () => void;
    activeTab: string;
    filterIssuesByTab: (issues: Issue[], tab: string) => Issue[];
    handleLocateIssue: (issue: Issue) => void;
    ...
    const [expandedIssueIds, setExpandedIssueIds] = useState<{ [key: string]: boolean }>({});
  ...
  <div className="issue-type-info">
    {/* Make sure icon has proper fill value */}
    {icon}
        ...
        {isExpanded && (
          <div className="issue-type-content">
            ...
            {tabFilteredIssues.map((issue) => (
              <div key={issue.id} className="issue-item-wrapper">
                <div 
  className={`issue-item-compact ${expandedIssueIds[issue.id] ? 'expanded' : ''}`}
>
...
<mask id="mask0_1_289" maskUnits="userSpaceOnUse" x="0" y="0" width="14" height="14">
<path d="M1.63818 2.35302C1.63818 2.12108 1.73032 1.89865 1.89432 1.73465C2.05832 1.57065 2.28075 1.47852 2.51268 1.47852H9.50868C9.74061 1.47852 9.96305 1.57065 10.127 1.73465C10.291 1.89865 10.3832 2.12108 10.3832 2.35302V13.1385H2.51268C2.28075 13.1385 2.05832 13.0464 1.89432 12.8824C1.73032 12.7184 1.63818 12.4959 1.63818 12.264V2.35302Z" fill="white" stroke="white" stroke-width="1.466" stroke-linejoin="round"/>
<path d="M10.3833 7.30852C10.3833 7.1539 10.4447 7.00562 10.5541 6.89628C10.6634 6.78695 10.8117 6.72552 10.9663 6.72552H12.1323C12.2869 6.72552 12.4352 6.78695 12.5445 6.89628C12.6539 7.00562 12.7153 7.1539 12.7153 7.30852V12.264C12.7153 12.496 12.6232 12.7184 12.4592 12.8824C12.2952 13.0464 12.0727 13.1385 11.8408 13.1385H10.3833V7.30852Z" stroke="white" stroke-width="1.466" stroke-linejoin="round"/>
<path d="M3.38721 3.81049H5.71921M3.38721 5.85099H6.88521" stroke="black" stroke-width="1.466" stroke-linecap="round" stroke-linejoin="round"/>
</mask>
<g mask="url(#mask0_1_289)">
<path d="M0.180664 0.3125H14.1727V14.3045H0.180664V0.3125Z" fill="black"/>
</g>
</svg>
Show Details
                    </button>
                ...
                {expandedIssueIds[issue.id] && (
                  <div className="issue-expanded-details">
                    {/* WCAG Guidelines box */}
                    {issue.wcagGuideline && (
                      <div className="details-box wcag-box">
                    ...
                    {/* Suggested Fixes box */}
                    {issue.fixSuggestions && issue.fixSuggestions.length > 0 && (
                      <div className="details-box fix-suggestions-box">
                        <div className="details-box-header">
                          <h4>Suggested Fixes:</h4>
                        </div>
                        <div className="details-box-content">
                    ...
                    {/* Actions for the expanded view */}
                    <div className="expanded-actions">
                      <button 
                        className="locate-button-small expanded"
                        onClick={() => handleLocateIssue(issue)}
                      >
                      <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path d="M8 8.5C8.82843 8.5 9.5 7.82843 9.5 7C9.5 6.17157 8.82843 5.5 8 5.5C7.17157 5.5 6.5 6.17157 6.5 7C6.5 7.82843 7.17157 8.5 8 8.5Z" fill="white"/>
          ...
          {filterIssuesByTab(issues, activeTab).length > 0 && (
            ...
            <IssueTypeItem
              icon={<svg width="21" height="17" viewBox="0 0 21 17" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M1.11719 3.30853V1.30853H14.1172V3.30853M8.11719 1.30853V15.3085M10.1172 15.3085H6.11719M13.1172 9.30853V8.30853H19.1172V9.30853M16.1172 8.30853V15.3085M15.1172 15.3085H17.1172" stroke="black" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" className="svg-path"/>
                </svg>}
              label="Text Size"
              issues={textSizeIssues}
              isExpanded={expandedTypes.textSize}
              toggleExpand={() => toggleExpand('textSize')}
              activeTab={activeTab}
              filterIssuesByTab={filterIssuesByTab}
              handleLocateIssue={handleLocateIssue}
              getIssueTypeDescription={getIssueTypeDescription}
            ...
            <IssueTypeItem
              icon={ <svg width="14" height="9" viewBox="0 0 14 9" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M0.0703125 8.94141L1.55859 0.697266C1.56641 0.666016 1.58594 0.650391 1.61719 0.650391H3.35742C3.38867 0.650391 3.4082 0.666016 3.41602 0.697266L4.8457 8.94141C4.84961 8.98047 4.83398 9 4.79883 9H3.46875C3.42969 9 3.4082 8.98047 3.4043 8.94141L3.27539 8.0625H1.64062L1.51172 8.94141C1.50781 8.98047 1.48828 9 1.45312 9H0.117188C0.0859375 9 0.0703125 8.98047 0.0703125 8.94141ZM2.41992 3.41016L1.88086 6.7793H3.03516L2.54297 3.41016L2.47266 2.96484L2.41992 3.41016ZM9.52148 9H5.64258C5.61133 9 5.5957 8.98047 5.5957 8.94141L5.60742 0.708984C5.60742 0.669922 5.62695 0.650391 5.66602 0.650391H7.00195C7.04102 0.650391 7.06055 0.669922 7.06055 0.708984L7.04883 7.52344H9.52148C9.56055 7.52344 9.58008 7.54297 9.58008 7.58203V8.94141C9.58008 8.98047 9.56055 9 9.52148 9ZM12.082 9H10.7285C10.6934 9 10.6758 8.98047 10.6758 8.94141V2.09766H9.11719C9.07812 2.09766 9.05859 2.07812 9.05859 2.03906L9.07031 0.697266C9.07031 0.666016 9.08594 0.650391 9.11719 0.650391H13.6758C13.7188 0.650391 13.7402 0.666016 13.7402 0.697266V2.03906C13.7402 2.07812 13.7246 2.09766 13.6934 2.09766H12.1172L12.1289 8.94141C12.1289 8.98047 12.1133 9 12.082 9Z" className="svg-path"/>
                </svg>}
              label="Alt text"
              issues={altTextIssues}
              isExpanded={expandedTypes.altText}
              toggleExpand={() => toggleExpand('altText')}
              activeTab={activeTab}
              filterIssuesByTab={filterIssuesByTab}
              handleLocateIssue={handleLocateIssue}
              getIssueTypeDescription={getIssueTypeDescription}
            ...
            <IssueTypeItem
              icon={<svg width="21" height="20" viewBox="0 0 21 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path fill-rule="evenodd" clip-rule="evenodd" d="M17.687 0.792445C18.643 0.448445 19.5671 1.37245 19.2231 2.32745L13.1831 19.1044C12.8081 20.1474 11.3411 20.1674 10.937 19.1344L8.10805 11.9064L0.880051 9.07845C-0.151949 8.67445 -0.13195 7.20745 0.910051 6.83145L17.687 0.792445Z" className="svg-path"/>
                </svg>}
              label="Navigation"
              issues={navigationIssues}
              isExpanded={expandedTypes.navigation}
              toggleExpand={() => toggleExpand('navigation')}
              activeTab={activeTab}
              filterIssuesByTab={filterIssuesByTab}
              handleLocateIssue={handleLocateIssue}
              getIssueTypeDescription={getIssueTypeDescription}
